---
slug: /references/medusa-workflows/updateProductCategoriesWorkflow
sidebar_label: updateProductCategoriesWorkflow
sidebar_description: Update product categories.
tags:
  - product
  - event bus
  - workflow
...
[Update Product Category Admin API Route](https://docs.medusajs.com/api/admin#product-categories\_postproductcategoriesid).

You can use this workflow within your customizations or your own custom workflows, allowing you to
update product categories within your custom flows.

<SourceCodeLink link="https://github.com/medusajs/medusa/blob/b9edc066c8486e8ec52e4f505968db1c558bc7b8/packages/core/core-flows/src/product-category/workflows/update-product-categories.ts#L46" />
...
export async function POST(
  ...
  const { result } = await updateProductCategoriesWorkflow(req.scope)
    .run({
      input: {
        selector: {
          id: "pcat_123",
...
const myWorkflow = createWorkflow(
  "my-workflow",
  () => {
    const result = updateProductCategoriesWorkflow
      .runAsStep({
        input: {
          selector: {
            id: "pcat_123",
